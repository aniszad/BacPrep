...
@Parcelize
open class MathPrograms : BranchProgram(),Parcelable {
    ...
    fun calculateAverage(
        ...
        if (noteTamazight == null && noteSport == null){
            val sum = ((noteSci * 2) + (notePhy * 6) + (noteMath * 7) + (noteArab * 3)
    ...
    override fun getScienceProgram() : Pair<List<String>, HashMap<String, List<String>>>{
        val groupList = listOf(
            "التخصص الوظيفي للبروتينات: تركيب البروتين",
            "التخصص الوظيفي للبروتينات:العلاقة بين بنية ووظيفة البروتين",
            "التخصص الوظيفي للبروتينات: دور البروتينات في الدفاع عن الذات",
            "الإنسان وتسيير الكوكب: نشاطات الإنسان مصدر تلوث الجو والرهانات العالمية من أجل بيئة متوازنة",
            "التخصص الوظيفي للبروتينات: نشاطات الإنسان مصدر تلوث الماء",
        )
        val itemsList = hashMapOf(
            groupList[0] to listOf(
                "آليات تركيب البروتين عند خليةالحية.",
                "آلية الاستنساخ",
                "الشفرة الوراثية",
                "على دور الـARNt",
                "الية الترجمة",
            ...
            groupList[2] to listOf(
                "الذات و اللاذات.",
                "دور البروتينات حالة الرد المناعي الخلطي",
                "دور البروتينات حالة الرد المناعي الخلوي",
                "تحفيز الخلايا اللمفاوية.",
                "فقدان المناعة المكتسبة.",
            ),
            groupList[3] to listOf(
                "الاحتباس الحراري",
                "أسباب تدهور طبقة الأوزون",
            ),
    ...
    override fun getMathProgram() : Pair<List<String>, HashMap<String, List<String>>>{
        val groupList = listOf(
            ...
            "الأعداد و الإحصاء", // alhisab math tech
            "احتمالات وإحصاء",
            "الأعداد مركبة",
            "التحويلات النقطية",
            "الهندسة في الفضاء",
