...
class MultiLangStrings(context: Context) {
    ...
    // USER roles
    val STUDENT_ROLE: String = context.resources.getStringArray(R.array.role_choices)[0]
    val CREATOR_ROLE: String = context.resources.getStringArray(R.array.role_choices)[1]
    val TEACHER_ROLE: String = context.resources.getStringArray(R.array.role_choices)[2]


    // MODULE NAMES
    var SCIENCE: String = context.getString(R.string.science)
    var MATHEMATIQUE: String = context.getString(R.string.mathematique)
    var PHYSIQUE: String = context.getString(R.string.physique)
    val HISTOIRE: String = context.getString(R.string.histoire)
    var GEOGRAPHIE: String = context.getString(R.string.geographie)
    var ANGLAIS: String = context.getString(R.string.anglais)
    var FRANCAIS: String = context.getString(R.string.francais)
    var ARABE: String = context.getString(R.string.arabe)
    var S_ISLAMIQUE: String = context.getString(R.string.s_islamique)
    var PHILO: String = context.getString(R.string.philo)
    var GENIE_DES_PROCEDES: String = context.getString(R.string.genie_des_procédés)
    var GENIE_ELECTRIQUE: String = context.getString(R.string.genie_electrique)
    var GENIE_CIVIL: String = context.getString(R.string.genie_civil)
    var GENIE_MECANIQUE: String = context.getString(R.string.genie_mecanique)
    var ECONOMIE_ET_GESTION: String = context.getString(R.string.economie_et_gestion)
    var LOI: String = context.getString(R.string.loi)
    var GESTION_COMPTABLE_ET_FINANCIERE: String = context.getString(R.string.gestion_comptable_et_financiere)
    var ESPAGNOL: String = context.getString(R.string.espagnol)
    var ALLEMAND: String = context.getString(R.string.allemand)

    // filieres
    var SCIENCE_BRANCH: String = context.getString(R.string.science_filiere)
    var MATH_BRANCH: String = context.getString(R.string.math_filiere)
    var GESTION_BRANCH: String = context.getString(R.string.gestion_filiere)
    var LANGUES_BRANCH: String = context.getString(R.string.langues_filiere)
    var LETTRE_BRANCH: String = context.getString(R.string.lettre_filiere)
    var MATH_TECH_MEC_BRANCH: String = context.getString(R.string.math_tech_branch_mec)
    var MATH_TECH_ELE_BRANCH: String = context.getString(R.string.math_tech_branch_ele)
    var MATH_TECH_CIV_BRANCH: String = context.getString(R.string.math_tech_branch_civ)
    var MATH_TECH_METH_BRANCH: String = context.getString(R.string.math_tech_branch_meth)

    // Quiz Types
    var QUIZ_TYPE: String = Constants.QUIZ_TYPE
    var QUIZ_SEMESTER: String = Constants.SEMESTER
    var DATES_QUIZ: String = context.getString(R.string.dates)
    val PERSO_QUIZ: String = context.getString(R.string.perso_quiz)
    var TERMES_QUIZ: String = context.getString(R.string.termes_quiz)

    var SEMESTER: String = context.getString(R.string.semester)
    var SEMESTER_1: String = context.getString(R.string.semester_1)
    var SEMESTER_2: String = context.getString(R.string.semester_2)
    var SEMESTER_3: String = context.getString(R.string.semester_3)
    var SEMESTER_ALL: String = context.getString(R.string.semester_all)
    ...
    fun getHisAllPersoQuiz(): Quiz {
        val hisPerso1 = getHisPersoQuizSemester1().questions
        val hisPerso2 = getHisPersoQuizSemester2().questions
        val hisPerso3 = getHisPersoQuizSemester3().questions
    ...
    fun getHisAllDatesQuiz(): Quiz {
        val hisDates1 = getHisDatesQuizSemester1().questions
        val hisDates2 = getHisDatesQuizSemester2().questions
        val hisDates3 = getHisDatesQuizSemester3().questions
    ...
    fun getHisAllTermesQuiz(): Quiz {
        val hisTermes1 = getHisTermesQuiz1().questions
        val hisTermes2 = getHisTermesQuiz2().questions
        val hisTermes3 = getHisTermesQuiz3().questions
    ...
    fun getAllHistoryQuizzes(): List<Quiz> {
        return listOf(
            getHisPersoQuizSemester1(),
            getHisDatesQuizSemester1(),
            getHisTermesQuiz1(),
            getHisPersoQuizSemester2(),
            getHisDatesQuizSemester2(),
            getHisTermesQuiz2(),
            getHisPersoQuizSemester3(),
            getHisDatesQuizSemester3(),
            getHisTermesQuiz3(),
            getHisAllPersoQuiz(),
            getHisAllDatesQuiz(),
            getHisAllTermesQuiz()
    ...
    fun translateModuleName(moduleName: String): String {
        return when(moduleName){
            Constants.SCIENCE ->{
                this@MultiLangStrings.SCIENCE
            }
            Constants.MATHEMATIQUE ->{
                this@MultiLangStrings.MATHEMATIQUE
            }
            Constants.PHYSIQUE ->{
                this@MultiLangStrings.PHYSIQUE
            }
            Constants.HISTOIRE ->{
                this@MultiLangStrings.HISTOIRE
            }
            Constants.GEOGRAPHIE ->{
                this@MultiLangStrings.GEOGRAPHIE
            }
            Constants.ANGLAIS ->{
                this@MultiLangStrings.ANGLAIS
            }
            Constants.FRANCAIS ->{
                this@MultiLangStrings.FRANCAIS
            }
            Constants.ARABE ->{
                this@MultiLangStrings.ARABE
            }
            Constants.S_ISLAMIQUE ->{
                this@MultiLangStrings.S_ISLAMIQUE
            }
            Constants.PHILO ->{
                this@MultiLangStrings.PHILO
            }
            Constants.GENIE_DES_PROCEDES ->{
                this@MultiLangStrings.GENIE_DES_PROCEDES
            }
            Constants.GENIE_CIVIL ->{
                this@MultiLangStrings.GENIE_CIVIL
            }
            Constants.TECHNOLOGIE_ELEC ->{
                this@MultiLangStrings.GENIE_ELECTRIQUE
            }
            Constants.GENIE_MECANIQUE ->{
                this@MultiLangStrings.GENIE_MECANIQUE
            }
            Constants.ECONOMIE_ET_GESTION ->{
                this@MultiLangStrings.ECONOMIE_ET_GESTION
            }
            Constants.LOI ->{
                this@MultiLangStrings.LOI
            }
            Constants.ESPAGNOL ->{
                this@MultiLangStrings.ESPAGNOL
            }
            Constants.ALLEMAND ->{
                this@MultiLangStrings.ALLEMAND
            }
            else->{
                "__module__"
            }
