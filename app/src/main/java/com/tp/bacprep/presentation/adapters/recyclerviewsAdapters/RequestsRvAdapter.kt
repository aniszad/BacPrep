...
import com.tp.bacprep.databinding.RequestViewItemLayoutBinding
...
class RequestsRvAdapter(private val context: Context, private var requestList : List<Request>, private val receiver : String) : RecyclerView.Adapter<ViewHolder>() {
    companion object{
        const val VIEW_TYPE_EMPTY = 0
        const val VIEW_TYPE_REQUESTS = 1
        const val VIEW_LOAD_MORE_REQUESTS = 2
    }
    var answerRequestClickListener  : AnswerRequestClickListener? = null
    ...
    class RequestsViewHolder(binding : RequestViewItemLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        var btnAnswer = binding.btnAnswerRequest
    ...
    interface AnswerRequestClickListener {
        fun onAnswerButtonClicked(request: Request)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return when(viewType){
            VIEW_TYPE_REQUESTS ->{
                RequestsViewHolder(RequestViewItemLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false))
            }
            VIEW_TYPE_EMPTY ->{
                ...
                holder.apply {
                    ...
                    if (receiver == Constants.USER) {
                        ...
                        btnAnswer.setOnClickListener {
                            answerRequestClickListener?.onAnswerButtonClicked(currentRequest)
                        }
                    }
